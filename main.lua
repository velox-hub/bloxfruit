    ...
    if ActiveVirtualKeys[id] then 
        ...
        btn.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                if id == "Dodge" or id == "M1" then
                    local mode = "HOLD"
                    if id == "Dodge" then mode = Settings_Mode_Dash
                    elseif id == "M1" then mode = Settings_Mode_M1 end

                    local action = nil
                    if id == "Dodge" then action = TriggerDodge
        ...
        btn.InputEnded:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                if (id == "Dodge" and Settings_Mode_Dash == "HOLD") or 
...
local LayList = Instance.new("UIListLayout"); LayList.Parent=P_Lay; LayList.Padding=UDim.new(0, 8); LayList.SortOrder="LayoutOrder"; LayList.HorizontalAlignment="Center" 
...
local Grid1 = Instance.new("UIGridLayout"); Grid1.Parent=SetBox; Grid1.CellSize = UDim2.new(0.48, 0, 0, 32); Grid1.CellPadding = UDim2.new(0.04, 0, 0.04, 0) 
...
CalibBox.Parent = SettingsScroll 

local CalibGrid = Instance.new("UIGridLayout")
CalibGrid.Parent = CalibBox
CalibGrid.CellSize = UDim2.new(0.96, 0, 1, 0) 
